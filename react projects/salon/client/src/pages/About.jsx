        ...
        <>
            <main className="about-container">
                ...
                <section className="contact">
                    <p>Ready to experience the Beauté Salon difference? Contact us today to schedule your appointment. We look forward to welcoming you to our salon family.</p>
                </section>
            </main>
        </>
    )
